...
extern "C" __declspec(dllexport) Manipulator* instantiate_add_on(BBitmap*,ManipulatorInformer *i);
extern "C" __declspec(dllexport) char name[255] = "Enhance Edges";
extern "C" __declspec(dllexport) char menu_help_string[255] = "Enhances the edges in the current layer.";
