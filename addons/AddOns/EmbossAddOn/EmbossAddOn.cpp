...
extern "C" __declspec(dllexport) char name[255] = "Emboss";
extern "C" __declspec(dllexport) char menu_help_string[255] = "Creates an emboss effect on the active layer.";
