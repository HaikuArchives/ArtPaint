...
extern "C"
{
	...
	char menu_help_string[255] = B_TRANSLATE_MARK("Extracts the color components for printing.");
...
int32
ColorSeparatorManipulator::PreviewBitmap(bool full_quality, BRegion* updated_region)
{
...
void
ColorSeparatorManipulator::Reset()
{
...
void
ColorSeparatorManipulator::separate_colors()
{
...
BView*
ColorSeparatorManipulator::MakeConfigurationView(const BMessenger& target)
{
	if (config_view == NULL) {
...
ManipulatorSettings*
ColorSeparatorManipulator::ReturnSettings()
{
...
void
ColorSeparatorManipulator::ChangeSettings(ManipulatorSettings* s)
{
	ColorSeparatorManipulatorSettings* new_settings;
...
const char*
ColorSeparatorManipulator::ReturnName()
{
...
const char*
ColorSeparatorManipulator::ReturnHelpString()
{
...
ColorSeparatorManipulatorView::ColorSeparatorManipulatorView(
	ColorSeparatorManipulator* manip, const BMessenger& t)
	:
	WindowGUIManipulatorView()
{
	...
	cmyk_menu_field = new BMenuField("cmyk_menu_field", B_TRANSLATE("Select C-M-Y-K:"), cmyk_menu);
...
void
ColorSeparatorManipulatorView::AttachedToWindow()
{
...
void
ColorSeparatorManipulatorView::AllAttached()
{
}


void
ColorSeparatorManipulatorView::MessageReceived(BMessage* message)
{
	switch (message->what) {
...
void
ColorSeparatorManipulatorView::ChangeSettings(ManipulatorSettings* set)
{
	ColorSeparatorManipulatorSettings* new_settings
		= cast_as(set, ColorSeparatorManipulatorSettings);
