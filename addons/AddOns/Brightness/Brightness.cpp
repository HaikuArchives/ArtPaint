/* 
	...
	Contents:	Definitions for brightness add-on.	
...
extern "C" __declspec(dllexport) char name[255] = "Brightness…";
extern "C" __declspec(dllexport) char menu_help_string[255] = "Starts adjusting the image brightness.";
...
BBitmap* BrightnessManipulator::ManipulateBitmap(ManipulatorSettings *set,BBitmap *original,Selection *selection,BStatusBar *status_bar)	
{
...
int32 BrightnessManipulator::PreviewBitmap(Selection *selection,bool full_quality,BRegion *updated_region)
{
	progress_bar = NULL;
	current_selection = selection;
...
int32 BrightnessManipulator::thread_entry(void *data)
{
	int32 thread_number;
...
int32 BrightnessManipulator::thread_function(int32 thread_number)
{	
...
void BrightnessManipulator::MouseDown(BPoint point,uint32,BView*,bool first_click)
{
	// This function does nothing in BrightnessManipulator.
}


void BrightnessManipulator::SetPreviewBitmap(BBitmap *bm)
{
...
void BrightnessManipulator::Reset(Selection*)
{
...
ManipulatorSettings* BrightnessManipulator::ReturnSettings()
{
	return new BrightnessManipulatorSettings(settings);
}

void BrightnessManipulator::ChangeSettings(ManipulatorSettings *s)
{
...
void BrightnessManipulatorView::AttachedToWindow()
{
	WindowGUIManipulatorView::AttachedToWindow();
	brightness_slider->SetTarget(BMessenger(this));
}

void BrightnessManipulatorView::AllAttached()
{
	brightness_slider->SetValue(settings.brightness);
}


void BrightnessManipulatorView::MessageReceived(BMessage *message)
{
	switch (message->what) {
...
void BrightnessManipulatorView::ChangeSettings(ManipulatorSettings *set)
{
	BrightnessManipulatorSettings *new_settings = dynamic_cast<BrightnessManipulatorSettings*>(set);
