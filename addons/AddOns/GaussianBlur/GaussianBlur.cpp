...
int32
GaussianBlurManipulator::PreviewBitmap(bool full_quality, BRegion* updated_region)
{
	progress_bar = NULL;
...
BView*
GaussianBlurManipulator::MakeConfigurationView(const BMessenger& target)
{
	if (config_view == NULL) {
...
ManipulatorSettings*
GaussianBlurManipulator::ReturnSettings()
{
...
void
GaussianBlurManipulator::ChangeSettings(ManipulatorSettings* s)
{
	GaussianBlurManipulatorSettings* new_settings;
...
const char*
GaussianBlurManipulator::ReturnName()
{
...
const char*
GaussianBlurManipulator::ReturnHelpString()
{
...
GaussianBlurManipulatorView::GaussianBlurManipulatorView(
	GaussianBlurManipulator* manip, const BMessenger& t)
	:
	WindowGUIManipulatorView()
{
	...
	blur_slider = new BSlider("blur_slider", B_TRANSLATE("Blur size:"),
		new BMessage(BLUR_ADJUSTING_FINISHED), 0, 2000, B_HORIZONTAL, B_TRIANGLE_THUMB);
...
void
GaussianBlurManipulatorView::AttachedToWindow()
{
...
void
GaussianBlurManipulatorView::AllAttached()
{
...
void
GaussianBlurManipulatorView::MessageReceived(BMessage* message)
{
	switch (message->what) {
...
void
GaussianBlurManipulatorView::ChangeSettings(ManipulatorSettings* set)
{
	GaussianBlurManipulatorSettings* new_settings
		= dynamic_cast<GaussianBlurManipulatorSettings*>(set);
