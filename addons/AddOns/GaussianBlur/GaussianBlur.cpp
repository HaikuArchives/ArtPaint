...
extern "C" __declspec(dllexport) char name[255] = "Gaussian Blur…";
extern "C" __declspec(dllexport) char menu_help_string[255] = "Starts making gaussian blur to the image.";
