...
extern "C" __declspec(dllexport) char name[255] = "LogPolar Mapper";
extern "C" __declspec(dllexport) char menu_help_string[255] = "Maps image to it's polar coordinate representation.";
