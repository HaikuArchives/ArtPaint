...
#define B_TRANSLATION_CONTEXT "AddOns_StretchHistogram"


#ifdef __cplusplus
extern "C" {
#endif
	char name[255] = B_TRANSLATE_MARK("Stretch histogram");
	char menu_help_string[255]
		= B_TRANSLATE_MARK("Improves the contrast by stretching its histogram.");
...
BBitmap*
ContrastManipulator::ManipulateBitmap(BBitmap* original, BStatusBar*)
{
