...
BBitmap*
AntiDithererManipulator::ManipulateBitmap(
...
int32
AntiDithererManipulator::PreviewBitmap(bool full_quality, BRegion* updated_region)
{
...
BView*
AntiDithererManipulator::MakeConfigurationView(const BMessenger& target)
{
	if (config_view == NULL) {
...
ManipulatorSettings*
AntiDithererManipulator::ReturnSettings()
{
...
void
AntiDithererManipulator::ChangeSettings(ManipulatorSettings* s)
{
...
const char*
AntiDithererManipulator::ReturnName()
{
...
const char*
AntiDithererManipulator::ReturnHelpString()
{
...
AntiDithererManipulatorView::AntiDithererManipulatorView(
	AntiDithererManipulator* manip, const BMessenger& t)
	:
	WindowGUIManipulatorView()
{
	...
	block_size_control
		= new BSpinner("blocksize", B_TRANSLATE("Block size:"), new BMessage(BLOCK_SIZE_ADJUSTED));
	block_size_control->SetMinValue(1);
	block_size_control->SetValue(1);

	reduce_resolution_box = new BCheckBox("reduce_resolution", B_TRANSLATE("Reduce resolution"),
...
void
AntiDithererManipulatorView::AttachedToWindow()
{
...
void
AntiDithererManipulatorView::AllAttached()
{
...
void
AntiDithererManipulatorView::MessageReceived(BMessage* message)
{
	switch (message->what) {
...
void
AntiDithererManipulatorView::ChangeSettings(ManipulatorSettings* set)
{
	AntiDithererManipulatorSettings* new_settings = cast_as(set, AntiDithererManipulatorSettings);
