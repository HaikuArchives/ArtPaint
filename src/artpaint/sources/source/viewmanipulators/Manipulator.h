...
/*
	...
	The internal manipulators each need one constant to identify them. The constants
	are used with a method that generates proper manipulator when given a manipulator_type
	and an optional add_on_id.
*/
...
#define ADD_ON_API_VERSION	0x06
