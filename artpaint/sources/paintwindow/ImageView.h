...
// These functions are used for the threads that we may spawn from within the window's
// thread.

// The first function is a function that can be used to start one of the actual
// thread functions.
