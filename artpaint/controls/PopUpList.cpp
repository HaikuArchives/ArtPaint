...
PopUpList::PopUpList(BRect frame, BBitmap* down, BBitmap* up, const BMessage& list,
	int32 messageCount, const BMessenger& target)
	:
...
void
PopUpList::MouseDown(BPoint point)
{
