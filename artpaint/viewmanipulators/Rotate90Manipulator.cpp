...
BBitmap*
Rotate90ClockwiseManipulator::ManipulateBitmap(BBitmap* original, BStatusBar* status_bar)
{
...
const char*
Rotate90ClockwiseManipulator::ReturnName()
{
...
BBitmap*
Rotate90CounterclockwiseManipulator::ManipulateBitmap(BBitmap* original, BStatusBar* status_bar)
{
	// create a new bitmap that is as wide as the original is high
	BRect new_bounds(0, 0, original->Bounds().Height(), original->Bounds().Width());
	BBitmap* new_bitmap = new BBitmap(new_bounds, B_RGBA32);
...
const char*
Rotate90CounterclockwiseManipulator::ReturnName()
{
	return B_TRANSLATE("Rotate -90°");
}
